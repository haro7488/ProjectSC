...
{
    /// <summary>
    /// GachaHistoryScreen 프리팹 빌더 (자동 생성됨).
    /// Generated from: Assets/Prefabs/UI/Screens/GachaHistoryScreen.prefab
    /// Generated at: 2026-01-26 21:34:11
    /// </summary>
    public static class GachaHistoryScreenPrefabBuilder
    {
        #region Theme Colors
        ...
        /// <summary>
        /// GachaHistoryScreen 프리팹용 GameObject 생성.
        /// </summary>
        public static GameObject Build()
        {
            var root = CreateRoot("GachaHistoryScreen");

            var background = CreateBackground(root);
            var safeArea = CreateSafeArea(root);

            // Add main component
            root.AddComponent<GachaHistoryScreen>();
