...
{
    /// <summary>
    /// CharacterLevelUpPopup 프리팹 빌더 (자동 생성됨).
    /// Generated from: Assets/Prefabs/UI/Popups/CharacterLevelUpPopup.prefab
    /// Generated at: 2026-01-26 21:34:18
    /// </summary>
    public static class CharacterLevelUpPopupPrefabBuilder
    {
        #region Theme Colors
        ...
        /// <summary>
        /// CharacterLevelUpPopup 프리팹용 GameObject 생성.
        /// </summary>
        public static GameObject Build()
        {
            var root = CreateRoot("CharacterLevelUpPopup");

            var backdrop = CreateBackdrop(root);
            var container = CreateContainer(root);

            // Add main component
            root.AddComponent<CharacterLevelUpPopup>();
