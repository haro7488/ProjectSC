...
{
    /// <summary>
    /// CostConfirmPopup 프리팹 빌더 (자동 생성됨).
    /// Generated from: Assets/Prefabs/UI/Popups/CostConfirmPopup.prefab
    /// Generated at: 2026-01-26 21:34:19
    /// </summary>
    public static class CostConfirmPopupPrefabBuilder
    {
        #region Theme Colors
        ...
        private const float CONTAINER_HEIGHT = 350f;
        ...
        /// <summary>
        /// CostConfirmPopup 프리팹용 GameObject 생성.
        /// </summary>
        public static GameObject Build()
        {
            var root = CreateRoot("CostConfirmPopup");

            var backdrop = CreateBackdrop(root);
            var container = CreateContainer(root);

            // Add main component
            root.AddComponent<CostConfirmPopup>();
