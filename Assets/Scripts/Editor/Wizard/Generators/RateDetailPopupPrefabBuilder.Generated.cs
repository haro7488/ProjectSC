...
{
    /// <summary>
    /// RateDetailPopup 프리팹 빌더 (자동 생성됨).
    /// Generated from: Assets/Prefabs/UI/Popups/RateDetailPopup.prefab
    /// Generated at: 2026-01-26 21:34:20
    /// </summary>
    public static class RateDetailPopupPrefabBuilder
    {
        #region Theme Colors
        ...
        /// <summary>
        /// RateDetailPopup 프리팹용 GameObject 생성.
        /// </summary>
        public static GameObject Build()
        {
            var root = CreateRoot("RateDetailPopup");

            var backdrop = CreateBackdrop(root);
            var container = CreateContainer(root);

            // Add main component
            root.AddComponent<RateDetailPopup>();
